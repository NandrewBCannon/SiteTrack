...
export function AssetCard({ asset }: { asset: AssetView }) {
  ...
  return (
    <Link
      ...
      className="group grid overflow-hidden rounded-[8px] border border-zinc-200 bg-white shadow-panel transition hover:-translate-y-0.5 hover:border-zinc-300 sm:grid-cols-[168px_1fr]"
    >
